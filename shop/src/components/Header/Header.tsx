          ...
          <form className='col-span-9'>
            <div className='flex rounded-sm bg-white p-1'>
              <input
                ...
                // {...register('name')}
              />
              <button className='flex-shrink-0 rounded-sm bg-purple-300 py-2 px-6 hover:opacity-90'>
                <svg
                  ...
                  <div className='p-2'>
                      ...
                      <div className='mt-6 flex items-center justify-between'>
                        ...
                        <Link
                          // to={path.cart}
                          to='/log-in'
                          className='rounded-sm bg-purple-300 px-4 py-2 capitalize text-white hover:bg-opacity-90'
                        >
                          Xem giỏ hàng
                        </Link>
                      </div>
